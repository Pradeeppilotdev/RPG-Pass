...
const ClaimPerks = () => {
  ...
  // Mock function for Reclaim
  const handleClaim = (provider) => {
    console.log(`Triggering Reclaim for ${provider}`);
    // Once done, you might redirect back:
    // navigate('/dashboard');
  };
      ...
      <div className="quests-list">
        ...
        <div className="quest-row">
          ...
          <div className="quest-details">
            ...
            <p>Verify 50+ Commits on GitHub</p>
          </div>
          <button className="claim-btn" onClick={() => handleClaim('github')}>
            CLAIM REWARD
          </button>
        </div>
        ...
        <div className="quest-row">
          ...
          <div className="quest-details">
            <div className="quest-header">
              ...
              <span className="xp-badge">+30 XP</span>
            </div>
            <p>Verify 1 Year+ Account Age</p>
          </div>
          <button className="claim-btn" onClick={() => handleClaim('twitter')}>
            CLAIM REWARD
          </button>
        </div>
